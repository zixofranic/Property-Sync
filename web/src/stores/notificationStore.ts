...
// TASK 10: Badge State Persistence
...
export const useBadgePersistenceStore = create<BadgePersistenceStore>()(
  persist(
    (set, get) => ({
      ...
      // TASK 10: Set cached badge state with timestamp
      ...
      // TASK 10: Get cached badge state with freshness check
      getCachedBadgeState: () => {
      ...
      // TASK 10: Check if cache is valid (not expired)
      isCacheValid: () => {
        const state = get().cachedBadgeState;
